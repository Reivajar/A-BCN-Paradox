...
% Max. flow ($\Phi_{max}$)(veh./h) & 989.1 & 555.8 & 372.8 & 438 \\ \midrule
...
\begin{figure}[htbp]
\centering
\subfloat[\centering left]{{
\includegraphics[width=0.45\textwidth]{code/simulations/charts/MFD01_compar_01-02-03-04_meso_AGG_4_AVG.png}
}}%
\qquad
\subfloat[\centering left]{{
\includegraphics[width=0.45\textwidth]{code/simulations/charts/MFD01_compar_01-02-03-04_micro.png}
}}%

\caption{MFD of mesoscopic simulations for the four proposed networks.}
\label{fig:MFD of microscopic simulation for the four proposed networks.}
\end{figure}
